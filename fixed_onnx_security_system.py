#!/usr/bin/env python3
"""
Fixed ONNX-based Security System for Raspberry Pi
- Fixes the NumPy array truth value issue
"""
...
class ONNXDetector:
    ...
    def postprocess(self, outputs, original_shape):
        ...
        for detection in detections:
            # Extract scalar confidence value from NumPy array
            ...
            if confidence > CONFIDENCE_THRESHOLD:
                ...
                class_score = float(class_probs[class_id])  # Convert to scalar
...
# ── Main Execution ────────────────────────────────────────────────────────────
def main():
    print("🚨 Fixed ONNX Security System for Raspberry Pi")
    print("=" * 55)
    print("Features:")
    print("• Real-time human detection (no PyTorch required)")
    print("• Buzzer alarm")
    print("• Video recording")
    print("• Fixed NumPy array issue")
    print("=" * 55)
