#!/bin/bash
# Raspberry Pi Security System Deployment Script
# ==============================================
# 
...
echo "🚨 Raspberry Pi Security System Deployment"
echo "=========================================="
echo
...
# Copy files from your current directory (assuming this script is run from project root)
echo "📋 Copying project files..."
cp /home/aidan/human-detector/raspberry_pi_security_system.py ~/security_system/
cp /home/aidan/human-detector/security_system_test.py ~/security_system/
cp /home/aidan/human-detector/yolov8n.pt ~/security_system/
cp /home/aidan/human-detector/README.md ~/security_system/
