#!/usr/bin/env python3
"""
Robust ONNX-based Security System for Raspberry Pi
- Handles multi-dimensional NumPy arrays properly
"""
...
# ── Main Execution ────────────────────────────────────────────────────────────
def main():
    print("🚨 Robust ONNX Security System for Raspberry Pi")
    print("=" * 55)
    print("Features:")
    print("• Real-time human detection (no PyTorch required)")
    print("• Buzzer alarm")
    print("• Video recording")
    print("• Handles multi-dimensional NumPy arrays")
    print("=" * 55)
