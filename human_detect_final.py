...
BUZZER_FREQUENCY = 1000  # 1kHz frequency for loud tone
buzzer_pwm = None
...
class ONNXSecuritySystem:
    ...
    def stop(self):
        ...
        # Clean up PWM before cleaning up GPIO
        global buzzer_pwm
    ...
    def _trigger_alarm(self):
        ...
        def alarm_thread():
            global buzzer_pwm
            # Create PWM object if it doesn't exist
            if buzzer_pwm is None:
                buzzer_pwm = GPIO.PWM(BUZZER_PIN, BUZZER_FREQUENCY)
            
            # Start PWM with 50% duty cycle for loud tone
            buzzer_pwm.start(50)
